...
| --- | --- | --- |
| Bootstrap bundle exists | Pass | `build-resources/c420ui/bootstrap/generated/run-c420ui.cjs` and `build-resources/c420ui/bootstrap/generated/run-c420ui-cli.cjs` are committed bootstrap entrypoints; `node build-resources/c420ui/bootstrap/generated/run-c420ui-cli.cjs --help` passed after `rm -rf node_modules .build`. |
