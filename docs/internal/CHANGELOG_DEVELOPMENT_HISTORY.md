...
> Internal archived granular development-cycle history. Not current release guidance.

This file preserves the detailed development changelog entries that were archived from the public changelog so `CHANGELOG.md` can remain release-focused.
