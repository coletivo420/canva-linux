...
- [ ] App-id uses `io.github.coletivo420.canva-linux`, not `com.canva.*`.
...
- The generated `packages/electron/preload/canva.bundle.js` should be regenerated from source during the build and should not replace review of the modular preload source files.
