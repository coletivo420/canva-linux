...
- The source archive is currently pinned to a GitHub commit tarball plus `sha256` to unblock technical validation of the Flathub pipeline during dev16.
...
# flatpak run --command=appstreamcli org.flatpak.Builder validate --pedantic --no-net data/com.canva.WebApp.metainfo.xml
