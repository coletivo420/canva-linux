...
1. **Local development flow**: `./canva-linux.sh --install` builds as the current user, exports `repo/`, and installs from that local repo into the system Flatpak scope by default.
