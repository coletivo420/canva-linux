...
This manifest documents the real screenshot files currently staged in `build-resources/canva-linux/assets/screenshots/` for AppStream metadata and future Flathub submission review.
