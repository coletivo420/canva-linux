#!/usr/bin/env bash
set -euo pipefail
# build-resources/c420ui/scripts/build-flatpak-bundle.sh - Generate a distributable Flatpak bundle on demand.
...
usage() {
  cat <<'USAGE'
Usage:
  ./build-resources/c420ui/scripts/build-flatpak-bundle.sh [--use-existing-repo]
