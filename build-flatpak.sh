...
echo "  Run with eyedropper debug:  CANVA_DEBUG=1 flatpak run com.canva.WebApp"
...
echo ""
echo "Expected eyedropper debug lines:"
echo "  [canva-eyedropper] preload-loaded ..."
echo "  [canva-eyedropper] installed ..."
echo "  [canva-eyedropper] get EyeDropper"
echo "  [canva-eyedropper] native open intercepted"
echo "  [canva-eyedropper] open-request"
echo "  [canva-eyedropper] picked"
