...
export const tuiTheme = {
  ...
  menu: {
    ...
    selected: { fg: 'black' as BlessedColor, bg: colors.lightBlue as BlessedColor, bold: true },
  ...
  footer: { fg: 'black' as BlessedColor, bg: colors.lightBlue as BlessedColor, bold: true },
  modal: {
