...
const colors = {
  ...
  selectionBg: supportsTrueColor ? themeConfig.palette.canvaLightBlue : 'cyan',
  selectionFg: 'black',
  ...
  nativeDetected: supportsTrueColor ? themeConfig.palette.canvaLightBlue : themeConfig.ansiFallback.primary,
  flatpakNotDetected: supportsTrueColor ? themeConfig.palette.canvaPurple : themeConfig.ansiFallback.accent,
