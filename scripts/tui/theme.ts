...
const colors = {
  ...
  helpTitle: supportsTrueColor ? themeConfig.palette.canvaBlue : themeConfig.ansiFallback.secondary,
  helpSectionTitle: supportsTrueColor ? themeConfig.palette.success : themeConfig.ansiFallback.success,
  infoItemTitle: supportsTrueColor ? themeConfig.palette.success : themeConfig.ansiFallback.success,
