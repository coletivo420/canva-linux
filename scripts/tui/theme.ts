...
const colors = {
  ...
  selectedBackground: supportsTrueColor ? themeConfig.palette.canvaLightBlue : 'cyan',
  selectedText: 'black',
};
export const tuiTheme = {
  supportsTrueColor, colors,
  header: { fg: colors.lightBlue as BlessedColor, bg: colors.background as BlessedColor, bold: true },
  menu: { fg: colors.text as BlessedColor, bg: colors.background as BlessedColor, border: { fg: colors.blue as BlessedColor }, selected: { fg: colors.selectedText as BlessedColor, bg: colors.selectedBackground as BlessedColor, bold: true }, item: { fg: colors.text as BlessedColor } },
  ...
  footer: { fg: colors.selectedText as BlessedColor, bg: colors.selectedBackground as BlessedColor, bold: true },
