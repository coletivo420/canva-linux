...
const criticalReadableSourceFiles = [
  ...
  "scripts/core/repository-policy-parts/check-no-source-javascript.ts",
  "scripts/core/repository-policy-parts/check-typescript-first.ts",
  "scripts/core/repository-policy-parts/check-source-integrity.ts",
