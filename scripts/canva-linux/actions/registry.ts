...
export function getActionsByGroup(
  ...
  return loadCanvaLinuxActionRegistry(rootDir).filter(
...
export function getActionById(
  ...
  return loadCanvaLinuxActionRegistry(rootDir).find((action) => action.id === id);
}
...
export function getActionByCliFlag(
  ...
  return loadCanvaLinuxActionRegistry(rootDir).find(
