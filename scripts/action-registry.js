...
let _actions; function loadActions(){ if(_actions) return _actions; _actions = JSON.parse(fs.readFileSync(actionsFile,"utf8")); validateActions(_actions); return _actions; }
