...
ui_init() {
  if supports_color; then
    ...
    UI_PRIMARY="${BLUE}"; UI_SECONDARY="${CYAN}"; UI_ACCENT="${MAGENTA}"; UI_SUCCESS="${GREEN}"; UI_WARNING="${YELLOW}"; UI_ERROR="${RED}"
    UI_DIVIDER_CHAR='━'
  fi
}
