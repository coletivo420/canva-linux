...
Request changes if a PR preparing `0.1.4-15.Dev.1` for credential persistence bugfix validation:
...
- marks `v0.1.4-15.Dev.1` ready while a release blocker remains open.
...
- changes version `0.1.4-15.Dev.1` without an explicit maintainer request;
