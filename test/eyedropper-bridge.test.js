...
test('registerEyeDropperBridge captures the resolved tab view', async () => {
  ...
  assert.deepEqual(debugEntries[0], ['eyedropper:bridge', 'snapshot-request', 'tab-7']);
  assert.deepEqual(debugEntries[1], ['eyedropper:bridge', 'snapshot', '640x360', 'css', '320x180']);
});
